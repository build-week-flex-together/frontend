...
class BuddyTellMore extends React.Component {
    constructor(props) {
        super(props);
            ...
            <div>
                ...
                <div>
                    <p>I prefer to receive notifications by: </p>
                        ...
                        <form>
                            <label>Email</label>
                            <input name='email' type='checkbox' value='email' required />
                            <label>Text</label>
                            <input name='text' type='checkbox' value='text' required />
                        </form>
                </div>
                <div>
